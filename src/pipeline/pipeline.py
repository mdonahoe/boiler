...
import time
import typing as T
from src.pipeline.models import GitState, RepairResult
...
def run_pipeline(stderr: str, stdout: str, git_state: GitState, debug: bool = False, execute: bool = False) -> RepairResult:
    """
