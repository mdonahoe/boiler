...
Use `analyze_legacy_handlers.py` to see which handlers are used most frequently:
...
2. Analyze the results: `python3 analyze_legacy_handlers.py`
...
1. Run `python3 analyze_legacy_handlers.py`
